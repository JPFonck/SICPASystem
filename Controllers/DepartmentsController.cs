...
namespace SICPASystem.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,created_by,created_date,modified_by,modified_date,status,description,name,phone")] DepartmentModel departmentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,created_by,created_date,modified_by,modified_date,status,description,name,phone")] DepartmentModel departmentModel)
        {
